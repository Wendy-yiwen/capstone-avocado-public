...
def test_channel_activity():
    ...
    reviews = [
    # z5325769 Rate others
    {"group_id": 2, "assignment_id": 1, "reviewer_zid": "z5325769", "reviewee_zid": "z5325799", "score": 8, "comment": "Great helper"},
    {"group_id": 2, "assignment_id": 1, "reviewer_zid": "z5325769", "reviewee_zid": "z7654321", "score": 6, "comment": "Contributed in parts"},
    
    # z5325799 Rate others
    {"group_id": 2, "assignment_id": 1, "reviewer_zid": "z5325799", "reviewee_zid": "z5325769", "score": 4, "comment": "Missed some meetings"},
    {"group_id": 2, "assignment_id": 1, "reviewer_zid": "z5325799", "reviewee_zid": "z7654321", "score": 7, "comment": "Solid effort"},
    
    # z7654321 Rate others
    {"group_id": 2, "assignment_id": 1, "reviewer_zid": "z7654321", "reviewee_zid": "z5325769", "score": 5, "comment": "Needs improvement"},
    {"group_id": 2, "assignment_id": 1, "reviewer_zid": "z7654321", "reviewee_zid": "z5325799", "score": 7, "comment": "Very responsive"}
]
    ...
    if response.status_code == 200:
        try:
            ...
            # Check if channel_activity data is included
