...
import { BsChatDots, BsPersonPlus, BsArrowLeftCircle, BsCheck2Square } from 'react-icons/bs';
...
export default function Example() {
  ...
  const navigation = [
    ...
    { name: 'Task', href: '/Task', icon: BsCheck2Square },
    { name: 'Meeting', href: '/Meeting', icon: UsersIcon },
    { name: 'New-Meeting', href: '/New-Meeting', icon: BsPersonPlus },
    { name: 'Channel', href: '/Channel', icon: BsChatDots },
    { name: 'Evaluation', href: '/Evaluation', icon: BsArrowLeftCircle },
  ]
